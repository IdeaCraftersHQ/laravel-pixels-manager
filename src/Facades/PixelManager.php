 ...
 * @method static static forPixels(int|array|\Illuminate\Support\Collection ...$pixelIds)
 * @method static static except(string ...$platforms)
 * @method static \Ideacrafters\PixelManager\Models\Pixel addPixel(string $platform, string $pixelId, ?string $accessToken = null)
